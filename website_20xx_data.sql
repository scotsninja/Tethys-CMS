...
('Core', 'Version', 'Release version of the Tethys CMS', 'string', '0.9.0', '0.8.0'),
('Core', 'Webmaster', 'Address to notify when fatal error occurs', 'email', NULL, 'kyle.k@20xxproductions.com'),
('Date', 'Display Format Date', 'Format for date strings', 'string', 'm/d/Y', 'm/d/Y'),
('Date', 'Display Format Time', 'Format for time strings', 'string', 'h:i A', 'h:i A'),
('Date', 'Display Format Datetime', 'Format for date and time strings', 'string', 'm/d/Y \\a\\t h:i A', 'm/d/Y \\a\\t h:i A'),
